...
from models import GicLoss, GMM, UnetGenerator, VGGLoss, save_checkpoint

from tensorboardX import SummaryWriter
from src.visualization.visualize import board_add_images
...
def get_opt():
    ...
    parser.add_argument('--checkpoint_dir', type=str,
                        default='/Users/elizastarr/git/clothing_deep_fakes/models/cp-vton-plus/GMM/gmm_final.pth', help='save checkpoint infos')
...
# GMM: /Users/elizastarr/git/clothing_deep_fakes/models/cp-vton-plus/GMM/gmm_final.pth
# TOM: /Users/elizastarr/git/clothing_deep_fakes/models/cp-vton-plus/TOM/tom_final.pth
...
def main():
    ...
    # create dataloader
    train_loader = CPDataLoader(dataset=train_dataset)
