...
import sys
#sys.path.append('/content/drive/MyDrive/ColabNotebooks/Resleeve/clothing_deep_fakes/src/')
sys.path.append('/Users/elizastarr/git/clothing_deep_fakes/src')
...
import os
import time
from data.cp_dataset import CPDataset, CPDataLoader
from networks import GMM, UnetGenerator, load_checkpoint

from tensorboardX import SummaryWriter
from visualization.visualize import board_add_image, board_add_images, save_images
...
def get_opt():
    ...
    parser.add_argument('--result_dir', type=str,
                        default='/content/drive/MyDrive/ColabNotebooks/Resleeve/clothing_deep_fakes/src/results', help='save result infos')

    # paths for Google Colab
    #parser.add_argument('--checkpoint', type=str, default='/content/drive/MyDrive/ColabNotebooks/Resleeve/clothing_deep_fakes/models/cp-vton-plus/GMM/gmm_final.pth', help='model checkpoint for test')
    #parser.add_argument('--checkpoint', type=str, default='/content/drive/MyDrive/ColabNotebooks/Resleeve/clothing_deep_fakes/models/cp-vton-plus/TOM/tom_final.pth', help='model checkpoint for test')
    # paths for local
    #parser.add_argument('--checkpoint', type=str, default='/Users/elizastarr/git/clothing_deep_fakes/models/cp-vton-plus/GMM/gmm_final.pth', help='model checkpoint for test')
    parser.add_argument('--checkpoint', type=str, default='/Users/elizastarr/git/clothing_deep_fakes/models/cp-vton-plus/TOM/tom_final.pth', help='model checkpoint for test')
...
def main():
    ...
    # create dataset
    test_dataset = CPDataset(dataroot=opt.dataroot, 
    ...
    # create dataloader
    test_loader = CPDataLoader(dataset=test_dataset)
